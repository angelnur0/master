...
<?if($arPost["PARAMS"]):?>
	...
	<script>
		...
		/*set store quantity*/
		setQuantityStore = function(quantity, text, indicators)
		{
		...
		ChangeInfo = function()
		{
			...
			if(-1 < index)
			{
				...
				setQuantityStore(obOffers[index].MAX_QUANTITY, obOffers[index].AVAILIABLE.TEXT, obOffers[index].AVAILIABLE.INDICATORS);
